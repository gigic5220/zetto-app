...
class PreferenceStorage {
  ...
  Future<String?> readStringByUserId(int userId, String key) {
    return _storage.read(key: '$userId-$key', iOptions: _getIOSOptions(), aOptions: _getAndroidOptions());
  }
  ...
  Future<void> clear() {
    return _storage.deleteAll(iOptions: _getIOSOptions(), aOptions: _getAndroidOptions());
  }

  Future<void> delete(String key) async {
    _storage.delete(key: key, iOptions: _getIOSOptions(), aOptions: _getAndroidOptions());
  }

  Future<void> deleteByUserId(int userId, String key) async {
    _storage.delete(key: '$userId-$key', iOptions: _getIOSOptions(), aOptions: _getAndroidOptions());
  }
